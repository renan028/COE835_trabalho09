...
%
\begin{enumerate}
 \item O sinal do ganho de alta frequência da planta, $k_p$, é conhecido;
 \item O sinal de referência $r(t)$ é limitado;
 \item $N<0 \,, \quad d_1 > 0 \,, \quad d_2 > 0$\,.
\end{enumerate}
